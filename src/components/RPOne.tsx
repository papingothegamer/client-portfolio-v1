...
import styles from '../styles/rpone.module.css';

const RandomProjectOne: React.FC = () => {
    return (
      <div className={styles.randomprojectone}>
       <a href="#">
        ...
        <h3 className={styles.headerText}> Random Project One</h3>
        <p className={styles.bodyText}> coming soon. </p>
      </div>
    );
  };

export default RandomProjectOne;